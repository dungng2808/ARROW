...
def parse_java_source(source_text: str, source_path: str, *, expected_name: str | None = None) -> JavaClass | None:
    ...
    if any(a.endswith("Generated") for a in annotations) or any(item.endswith(".Generated") for item in imports) or "/generated/" in f"/{source_path.lower()}/" or re.search(r"\b(?:generated by|auto-generated|do not edit)\b", source_text, re.IGNORECASE):
