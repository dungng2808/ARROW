...
Tự nhận diện OS/CPU, tìm JDK 8, 11, 17, 21 trên mọi ổ trước; chỉ tải
những major còn thiếu từ nguồn chính thức vào Java-version/runtime/jdk-8/,
jdk-11/, jdk-17/, jdk-21/ với binary đúng OS/CPU,
